...
(function () {
    ...
    function lumex(component, _object) {
      // HDrezka-only: disable lumex provider
      return;
      var extract = {};
      var object = _object;
      extract.seasons = [];
    ...
    function lumex2(component, _object) {
      // HDrezka-only: disable lumex2 provider
      return;
      var extract = [];
      var object = _object;
      var select_title = '';
    ...
    function kinobase(component, _object) {
      // HDrezka-only: disable kinobase provider
      return;
      var extract = [];
      var object = _object;
      var select_title = '';
    ...
    function collaps(component, _object, prefer_dash) {
      // HDrezka-only: disable collaps provider
      return;
      var extract = {};
      var object = _object;
      var select_title = '';
    ...
    function cdnmovies(component, _object) {
      // HDrezka-only: disable cdnmovies provider
      return;
      var extract = [];
      var object = _object;
      var select_title = '';
    ...
    function filmix(component, _object, _debug) {
      // HDrezka-only: disable filmix provider
      return;
      var extract = {};
      var object = _object;
      var debug = _debug;
    ...
    function zetflix(component, _object) {
      // HDrezka-only: disable zetflix provider
      return;
      var extract = [];
      var object = _object;
      var select_title = '';
    ...
    function fancdn(component, _object) {
      // HDrezka-only: disable fancdn provider
      return;
      var extract = [];
      var object = _object;
      var select_title = '';
    ...
    function fancdn2(component, _object) {
      // HDrezka-only: disable fancdn2 provider
      return;
      var extract = [];
      var object = _object;
      var select_title = '';
    ...
    function fanserials(component, _object) {
      // HDrezka-only: disable fanserials provider
      return;
      var extract = [];
      var object = _object;
      var select_title = '';
    ...
    function videoseed(component, _object) {
      // HDrezka-only: disable videoseed provider
      return;
      var extract = {};
      var object = _object;
      var select_title = '';
    ...
    function vibix(component, _object) {
      // HDrezka-only: disable vibix provider
      return;
      var extract = {};
      var object = _object;
      var select_title = '';
    ...
    function alloha(component, _object) {
      // HDrezka-only: disable alloha provider
      return;
      var extract = {};
      var object = _object;
      var select_title = '';
    ...
    function redheadsound(component, _object, prefer_dash) {
      // HDrezka-only: disable redheadsound provider
      return;
      var extract = [];
      var object = _object;
      var select_title = '';
    ...
    function cdnvideohub(component, _object) {
      // HDrezka-only: disable cdnvideohub provider
      return;
      var extract = {};
      var object = _object;
      var select_title = '';
    ...
    function anilibria(component, _object) {
      // HDrezka-only: disable anilibria provider
      return;
      var extract = {};
      var object = _object;
      var select_title = '';
    ...
    function anilibria2(component, _object) {
      // HDrezka-only: disable anilibria2 provider
      return;
      var extract = {};
      var object = _object;
      var select_title = '';
    ...
    function animelib(component, _object) {
      // HDrezka-only: disable animelib provider
      return;
      var extract = {};
      var object = _object;
      var select_title = '';
    ...
    function kodik(component, _object) {
      // HDrezka-only: disable kodik provider
      return;
      var extract = {};
      var object = _object;
      var select_title = '';
    ...
    function kinopub(component, _object) {
      // HDrezka-only: disable kinopub provider
      return;
      var extract = {};
      var object = _object;
      var select_title = '';
...
*/
    ...
    if (Utils.isDebug()) {
      ...
      // Removed Kinobase proxy toggle for non-HDrezka provider
      // Removed Collaps proxy toggle for non-HDrezka provider
      // Removed CDNMovies proxy toggle for non-HDrezka provider
      // Removed Filmix proxy toggle for non-HDrezka provider
    }

    if (Utils.isDebug()) {
      // Removed FanCDN proxy toggle for non-HDrezka provider
      // Removed FanCDN (ID) proxy toggle for non-HDrezka provider
      // Removed FanSerials proxy toggle for non-HDrezka provider
      // Removed VideoSeed proxy toggle for non-HDrezka provider
      // Removed Vibix proxy toggle for non-HDrezka provider
      // Removed RedHeadSound proxy toggle for non-HDrezka provider
    }
    ...
    {
      // Removed Collaps Lampa player toggle for non-HDrezka provider
    }
    ...
    if (Utils.isDebug()) {
      // Removed FanCDN login settings for non-HDrezka provider
    }

    if (Utils.isDebug()) {
      // Removed FanCDN cookie setting for non-HDrezka provider
    }

    if (Utils.isDebug()) {
      // Removed FanCDN fill-cookie action for non-HDrezka provider
    }

    if (Utils.isDebug()) {
      // Removed FanCDN token setting for non-HDrezka provider
    }
