...
(function(){
    ...
    function addExtractStyles(){
        ...
        $('body').append('<style id="flixio-extract-css"> .card.hero-banner {     width: 52vw !important;     height: 25em !important;     margin: 0 1.5em 0.3em 0 !important;     display: inline-block;     scroll-snap-align: start;     scroll-margin-left: 1.5em !important; } .scroll__content:has(.hero-banner) {     scroll-snap-type: x mandatory;     padding-left: 1.5em !important; } .scroll--mask .scroll__content { padding: 1.2em 1em 1em; } .row--card { margin-bottom: -1.2em !important; } .items-line { padding-bottom: 2em !important; } .card--studio {     width: 12em !important;     height: 6.75em !important;     padding: 0 !important;     background: #17191c !important;     background-color: #17191c !important;     background-image: none !important;     border-radius: 0.8em;     display: flex;     align-items: center;     justify-content: center;     overflow: hidden;     box-shadow: 0 3px 10px rgba(0,0,0,0.35);     border: 1px solid rgba(255,255,255,0.06);     transition: transform 0.18s ease-out, box-shadow 0.18s ease-out; } .card--studio.focus {     transform: scale(1.06);     box-shadow: 0 0 18px rgba(255,255,255,0.9);     z-index: 10; } .card--studio .card__view {     width: 100%; height: 100%; padding: 0.6em !important;     box-sizing: border-box !important;     background: #17191c !important;     background-color: #17191c !important;     background-image: none !important;     background-origin: content-box;     display: block; position: relative; } .card--studio .card__view::before, .card--studio .card__view::after { background: #17191c !important; background-color: #17191c !important; background-image: none !important; } .studio-logo-wrap {     width: 100%; height: 100%; display: flex;     align-items: center; justify-content: center; } .studio-logo-img {     max-width: 70%; max-height: 60%; object-fit: contain; display: block; } .studio-logo-fallback {     display: none; font-weight: 700; font-size: 1.05em;     text-align: center; color: #fff; padding: 0.4em; } .flixio-service-logo { display:inline-block; vertical-align:middle; margin-right:.4em; margin-bottom:.1em; } .flixio-service-logo img { height:1.4em; width:auto; display:block; } .flixio-extract .studios_main .card--wide, .flixio-extract .studios_view .card--wide, .studios_main .card--wide, .studios_view .card--wide { width:18.3em !important; } .studios_view .category-full { padding-top:1em; } .studio-subscription-btn {     display:inline-flex; align-items:center; justify-content:center; vertical-align:middle;     margin-left:.4em; padding:.18em .22em; font-size:.4em; font-weight:800;     line-height:1; letter-spacing:.02em; border-radius:.25em;     border:1px solid rgba(255,255,255,.2); cursor:pointer;     transition:box-shadow .15s, transform .15s; } .company-start__name { display:inline-flex; align-items:center; flex-wrap:wrap; } .studio-subscription-btn.studio-subscription-btn--sub {     background:linear-gradient(135deg,#1565c0,#42a5f5); color:#fff; border-color:rgba(66,165,245,.4); } .studio-subscription-btn.studio-subscription-btn--unsub {     background:linear-gradient(135deg,#37474f,#78909c); color:#fff; border-color:rgba(120,144,156,.4); } .studio-subscription-btn.focus { box-shadow:0 0 0 2px #fff; transform:scale(1.05); } .flixio-more-btn {     width:14em !important; height:21em !important; border-radius:.8em;     background:rgba(255,255,255,.05); display:flex; align-items:center;     justify-content:center; cursor:pointer; transition:transform .2s, background .2s;     order:9999 !important; } .flixio-more-btn:hover,.flixio-more-btn.focus {     background:rgba(255,255,255,.15); transform:scale(1.05); box-shadow:0 0 0 3px #fff; } .flixio-more-btn > div { text-align:center; } .hero-banner .card-marks,.hero-banner .card__icons,.hero-banner .card__quality { display:none !important; } .show-more-button.focus,.card.show-more-button:focus,.kino-card.show-more-button:hover,.kino-card.show-more-button.focus {     transform:scale(1.05) !important; box-shadow:0 0 0 3px #fff !important; z-index:10 !important; } .card--studio, .card--studio .card__view { background:#17191c !important; background-color:#17191c !important; background-image:none !important; } </style>');
    }
