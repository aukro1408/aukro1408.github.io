// ==UserScript==
// @name         Lampa Add "Хрень" Menu Item — Horror Mode
// @namespace    lampa.hren.horror
// @version      2.0
// @description  Добавляет пункт меню "Хрень" (ужасы) с пульсирующим сердечком
// @match        *://*/lampa/*
// ==/UserScript==
  ...
  function addHrenItem() {
    ...
    item.addEventListener('click', () => {
      ...
      try {
        ...
        // 🎬 Открываем категорию фильмов жанра "ужасы" (genre=27)
        Lampa.Activity.push({
