(function () {
    ...
    var PLUGIN_ICON = '<svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-label="cinemaX_ai"><defs><linearGradient id="cxg" x1="3" y1="3" x2="21" y2="21"><stop offset="0" stop-color="#ffffff"/><stop offset=".42" stop-color="#d8d8d8"/><stop offset=".7" stop-color="#ffb52e"/><stop offset="1" stop-color="#ff5a00"/></linearGradient><linearGradient id="cxb" x1="5" y1="4" x2="19" y2="20"><stop stop-color="#fff" stop-opacity=".95"/><stop offset=".5" stop-color="#ffb52e" stop-opacity=".85"/><stop offset="1" stop-color="#ff5a00" stop-opacity=".9"/></linearGradient><filter id="cxglow" x="-60%" y="-60%" width="220%" height="220%"><feGaussianBlur stdDeviation="1.2" result="b"/><feMerge><feMergeNode in="b"/><feMergeNode in="SourceGraphic"/></feMerge></filter></defs><g fill="none" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3.2c-2.1-1-4.8-.1-5.7 2-.4-.1-.8-.1-1.2 0-1.9.3-3 2.3-2.2 4 .1.2.2.4.4.6-1.2 1.5-.9 3.8.7 4.9.5.4 1.1.6 1.7.7.2 2 1.9 3.4 3.8 3.1.7 1.3 2.2 2.1 3.8 1.6.3-.1.6-.3.9-.5 1.4 1.1 3.5.9 4.6-.5.2-.3.4-.7.5-1.1 1.9.2 3.6-1.2 3.8-3.1.6-.1 1.2-.3 1.7-.7 1.6-1.2 1.9-3.4.7-4.9.1-.2.3-.4.4-.6.8-1.7-.3-3.7-2.2-4-.4-.1-.8-.1-1.2 0-.9-2.1-3.6-3-5.7-2v1.8" stroke="url(#cxg)" stroke-width="1.25" filter="url(#cxglow)"/><path d="M12 4.8v14.1M7.1 6.1c1 .8 1.5 1.8 1.4 3M5.3 9.5c1.2-.1 2.3.5 2.8 1.6M6 14.1c1.1-.4 2.3-.1 3 .8M16.9 6.1c-1 .8-1.5 1.8-1.4 3M18.7 9.5c-1.2-.1-2.3.5-2.8 1.6M18 14.1c-1.1-.4-2.3-.1-3 .8M9.4 16.2c.9-.2 1.8.2 2.2 1M14.6 16.2c-.9-.2-1.8.2-2.2 1" stroke="url(#cxb)" stroke-width=".9"/><path d="M4.3 8.4l2.4.9M19.7 8.4l-2.4.9M5.1 15.4l2.1-.7M18.9 15.4l-2.1-.7" stroke="#ff8a18" stroke-width=".7" opacity=".75"/><circle cx="12" cy="8.1" r=".75" fill="#fff" stroke="none"><animate attributeName="opacity" values=".25;1;.25" dur="1.8s" repeatCount="indefinite"/></circle><circle cx="8.2" cy="11.1" r=".55" fill="#ffb52e" stroke="none"><animate attributeName="opacity" values=".2;1;.2" dur="2.4s" begin=".4s" repeatCount="indefinite"/></circle><circle cx="15.8" cy="11.1" r=".55" fill="#ff6a00" stroke="none"><animate attributeName="opacity" values=".2;1;.2" dur="2.1s" begin=".8s" repeatCount="indefinite"/></circle><path d="M3.2 11.8c3.2-1.8 5.8-2.7 8.8-2.7s5.6.9 8.8 2.7" stroke="#fff" stroke-width=".45" opacity=".3"><animate attributeName="opacity" values=".05;.7;.05" dur="3s" repeatCount="indefinite"/></path></g></svg>';
    ...
    function AIAssistantPlugin() {
        ...
        this.drawButton = function (render, card) {
            ...
            var btn = $('<div class="full-start__button selector button--ai-assist">' + PLUGIN_ICON + '<span>cinemaX_ai</span></div>');
