(function () {
	...
	var Config = {
		...
		StorageKeys: {
			AlpacUnicId: "lampac_unic_id",
			AlpacProfileId: "lampac_profile_id",
	...
	var MY_AUTH = {
		...
		lampac_unic_id: Config.Auth.AlpacUnicId,
	};

	Lampa.Storage.set(Config.StorageKeys.AlpacUnicId, MY_AUTH.lampac_unic_id);
					...
					.then(function () {
						client.invoke(
							...
							JSON.stringify({
								...
								profile_id: Lampa.Storage.get(Config.StorageKeys.AlpacProfileId, ""),
