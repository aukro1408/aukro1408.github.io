(function () {
    ...
    //   winter  = Зима
    //   aurora  = Аврора (Пульс)
    //   cyberpunk = Киберпанк (Пульс)
    //   forestglow = Лесное свечение (Пульс)
    // =========================================================
    ...
    function seasonMenuSvg(theme) {
        ...
        if (theme === "aurora") {
            ...
            return `
                <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                    <path d="M4 11c4-5 8 3 12-2s8 3 12-2" fill="none" stroke="#ff4d30" stroke-width="2.4" stroke-linecap="round"/>
                    <path d="M4 18c4-5 8 3 12-2s8 3 12-2" fill="none" stroke="#70c1ff" stroke-width="2.4" stroke-linecap="round"/>
                    <path d="M4 25c4-5 8 3 12-2s8 3 12-2" fill="none" stroke="#c5d86d" stroke-width="2.4" stroke-linecap="round"/>
                </svg>
            `;
        }
        ...
        if (theme === "cyberpunk") {
            ...
            return `
                <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                    <path d="M16 4 28 16 16 28 4 16Z" fill="none" stroke="#00ffe0" stroke-width="2.2"/>
                    <path d="M16 10.5 21.5 16 16 21.5 10.5 16Z" fill="#ff0055"/>
                    <path d="M16 4V1.5M16 30.5V28M4 16H1.5M30.5 16H28" stroke="#9d00ff" stroke-width="1.6" stroke-linecap="round"/>
                </svg>
            `;
        }
        ...
        if (theme === "forestglow") {
            ...
            return `
                <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                    <circle cx="16" cy="16" r="9.5" fill="#34d399" opacity=".22"/>
                    <circle cx="16" cy="16" r="5" fill="#a3e635"/>
                    <circle cx="16" cy="16" r="2.1" fill="#f4fff8"/>
                    <path d="M16 2.5v3.5M16 26v3.5M2.5 16H6M26 16h3.5" stroke="#34d399" stroke-width="1.8" stroke-linecap="round"/>
                </svg>
            `;
        }
    }
    ...
    function addSeasonMenuIconStyle() {
        ...
        var css = `
            ...
            body.aurora-theme .af-season-menu-icon svg {
                filter: drop-shadow(0 1px 5px rgba(255, 110, 60, .45)) !important;
            }

            body.cyberpunk-theme .af-season-menu-icon svg {
                filter: drop-shadow(0 1px 5px rgba(0, 255, 224, .45)) !important;
            }

            body.forestglow-theme .af-season-menu-icon svg {
                filter: drop-shadow(0 1px 5px rgba(52, 211, 153, .45)) !important;
            }
        `;
    ...
    function applyCyberpunk() {
        ...
        addStyle(`
            ...
            body .card.focus {
                ...
                box-shadow:
                    0 0 0 2px #00ffe0,
                    0 0 18px rgba(0,255,224,.45) !important;
            }
    ...
    function applyForestGlow() {
        ...
        addStyle(`
            ...
            body .card.focus {
                ...
                box-shadow:
                    0 0 0 2px #34d399,
                    0 0 16px rgba(52,211,153,.4) !important;
            }
    ...
    function applyTheme() {
        ...
        } else if (currentTheme === "forestglow") {
