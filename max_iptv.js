...
Lampa.Template.add(plugin.component + '_style', '<style>'
    // --- layout: channel grid (left) + EPG rail (right) ---
    + '.PLUGIN.category-full{padding-bottom:8em}'
    + '#PLUGIN_epg{float:right;box-sizing:border-box;width:30%;padding:1.7em 1.8em;margin-top:.1em;background:rgba(255,255,255,.03);border:1px solid rgba(255,255,255,.07);border-radius:1.1em}'
    // --- channel cards ---
    + '.PLUGIN div.card__view{position:relative;background:#1b1b1b;border-radius:.9em;cursor:pointer;padding-bottom:58%;overflow:hidden;transition:transform .22s cubic-bezier(.2,.8,.2,1),box-shadow .22s ease}'
    + '.PLUGIN.square_icons div.card__view{padding-bottom:100%}'
    + '.PLUGIN .card--collection.focus div.card__view,.PLUGIN .card--collection.hover div.card__view{transform:scale(1.045);box-shadow:0 0 0 2px rgba(255,255,255,.9),0 .8em 2em rgba(0,0,0,.6)}'
    + '.PLUGIN img.card__img,.PLUGIN div.card__img{background:unset;border-radius:unset;max-height:100%;max-width:100%;height:auto;width:auto;position:absolute;top:50%;left:50%;-moz-transform:translate(-50%,-50%);-webkit-transform:translate(-50%,-50%);transform:translate(-50%,-50%);font-size:1.8em;font-weight:600;letter-spacing:.01em}'
    + '.PLUGIN.contain_icons img.card__img{height:92%;width:92%;object-fit:contain}'
    + '.PLUGIN .card__title{text-overflow:ellipsis;white-space:nowrap;overflow:hidden;font-weight:500;margin-top:.5em;opacity:.92}'
    + '.PLUGIN.category-full .card__icons{top:.4em;right:.4em;justify-content:right;gap:.3em}'
    + '.PLUGIN .card__icon.icon--timeshift{background-image:url(https://epg.rootu.top/img/icon/timeshift.svg);filter:drop-shadow(0 1px 2px rgba(0,0,0,.6))}'
    // --- live EPG strip under each card ---
    + '.PLUGIN .card__age{padding:0;border:none;margin-top:.5em;height:1.9em;border-radius:.45em;position:relative;overflow:hidden;background:rgba(255,255,255,.06);display:none}'
    + '.PLUGIN .card__age .card__epg-progress{position:absolute;top:0;left:0;bottom:0;width:0%;max-width:100%;background:rgba(255,255,255,.16)}'
    + '.PLUGIN .card__age .card__epg-title{position:relative;padding:0 .55em;line-height:1.9em;font-size:.82em;text-overflow:ellipsis;white-space:nowrap;overflow:hidden;opacity:.8}'
    + '.PLUGIN .card__age .card__epg-title::before{content:\'\';display:inline-block;width:.4em;height:.4em;margin-right:.5em;vertical-align:middle;border-radius:100%;background:#e2543c;box-shadow:0 0 .4em rgba(226,84,60,.7)}'
    // --- EPG rail typography ---
    + '.PLUGIN-details__group{font-size:1.1em;margin-bottom:.8em;opacity:.5;text-transform:uppercase;letter-spacing:.08em}'
    + '.PLUGIN-details__title{font-size:3.4em;font-weight:700;letter-spacing:-.01em}'
    + '#PLUGIN_epg .js-epgChannel{font-size:1.5em;font-weight:600;letter-spacing:-.01em;opacity:.94;margin:0 0 1em}'
    + '.PLUGIN-details__program-title{font-size:1em;text-transform:uppercase;letter-spacing:.1em;opacity:.42;font-weight:600;margin:1.3em 0 .8em}'
    + '.PLUGIN-details__program-list>div+div{margin-top:.7em}'
    + '.PLUGIN-details__program>div+div{margin-top:1.6em}'
    + '.PLUGIN-program{display:-webkit-box;display:-webkit-flex;display:-moz-box;display:-ms-flexbox;display:flex;font-size:1.05em;font-weight:300;padding:.5em .6em;border-radius:.6em;transition:background .18s ease}'
    + '.PLUGIN-program.selector.focus{background:rgba(255,255,255,.09)}'
    + '.PLUGIN-program__time{-webkit-flex-shrink:0;-ms-flex-negative:0;flex-shrink:0;width:4.4em;opacity:.55;position:relative;font-variant-numeric:tabular-nums}'
    + '.PLUGIN-program.focus .PLUGIN-program__time::after{content:\'\';position:absolute;top:.6em;right:.8em;width:.35em;height:.35em;background-color:#fff;-webkit-border-radius:100%;-moz-border-radius:100%;border-radius:100%}'
    + '.PLUGIN-program__title{opacity:.92;line-height:1.35}'
    + '.PLUGIN-program__progressbar{width:100%;height:.2em;border:none;border-radius:.2em;margin:.5em 0 0;background:rgba(255,255,255,.14);overflow:hidden}'
    + '.PLUGIN-program__progress{height:100%;border:none;border-radius:.2em;background:#fff;max-width:100%}'
    + '.PLUGIN-program__desc{font-size:.92em;line-height:1.55;margin:1em 0 0;opacity:.65;text-align:left;max-height:14em;overflow:hidden}'
...
function pluginPage(object) {
	...
	var bulkFn = bulkWrapper(function (channel) {
		...
		menu.push({
		    title: getStorage('epg', true) ? langGet('epg_off') :  langGet('epg_on'),
		    epgToggle: true
		});
		Lampa.Select.show({
