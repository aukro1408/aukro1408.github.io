...
//Стиль
Lampa.Template.add(plugin.component + '_style', '<style>#PLUGIN_epg{margin:0}.PLUGIN-program__desc{font-size:0.85em;margin:0.6em 0 0;line-height:1.4;text-align:justify;max-height:12em;overflow:hidden;opacity:0.75}.PLUGIN.category-full{padding-bottom:6em}.PLUGIN.category-full .card--collection{display:grid!important;grid-template-columns:4.6em 1fr;grid-template-rows:auto auto;align-items:center;column-gap:1em;width:100%!important;box-sizing:border-box;padding:0.7em 0.9em;margin:0 0 0.35em;border-radius:0.8em;background:rgba(255,255,255,0.03)}.PLUGIN.category-full .card--collection.focus{background:rgba(255,255,255,0.16)}.PLUGIN div.card__view{position:relative;grid-row:1/3;grid-column:1;width:4.6em;height:4.6em;padding-bottom:0;background-color:#353535;background-color:#353535a6;border-radius:0.7em;cursor:pointer}.PLUGIN.square_icons div.card__view{border-radius:50%}.PLUGIN img.card__img,.PLUGIN div.card__img{background-color:unset;border-radius:unset;max-height:100%;max-width:100%;height:auto;width:auto;position:absolute;top:50%;left:50%;-moz-transform:translate(-50%,-50%);-webkit-transform:translate(-50%,-50%);transform:translate(-50%,-50%);font-size:1.3em}.PLUGIN.contain_icons img.card__img{height:80%;width:80%;object-fit:contain}.PLUGIN .card__title{grid-row:1;grid-column:2;align-self:end;font-size:1.1em;font-weight:500;text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.PLUGIN .card__age{grid-row:2;grid-column:2;align-self:start;display:none;padding:0;border:none;margin:0.2em 0 0;border-radius:0;position:relative;background:none;opacity:0.65;max-width:100%;overflow:hidden}.PLUGIN .card__age .card__epg-progress{display:none}.PLUGIN .card__age .card__epg-title{position:relative;padding:0;font-size:0.85em;font-weight:300;text-overflow:ellipsis;white-space:nowrap;overflow:hidden;display:block;max-width:100%}.PLUGIN.category-full .card__icons{top:0.2em;right:0.2em;justify-content:right}#PLUGIN{float:right;padding:0.2em 0 0.2em 1.5em;width:58%;box-sizing:border-box;border-left:1px solid rgba(255,255,255,0.08)}.PLUGIN-details__group{font-size:1em;margin-bottom:0.6em;opacity:.5}.PLUGIN-details__title{font-size:2em;font-weight:700;margin-bottom:0.2em}.PLUGIN-details__program{padding-top:1.2em}.PLUGIN-details__program-title{font-size:1em;padding-left:0;margin-top:0;margin-bottom:0.8em;opacity:.5;text-transform:uppercase;letter-spacing:0.04em}.PLUGIN-details__program-list>div+div{margin-top:0.8em}.PLUGIN-details__program>div+div{margin-top:1.4em}.PLUGIN-program{display:-webkit-box;display:-webkit-flex;display:-moz-box;display:-ms-flexbox;display:flex;font-size:1em;font-weight:300}.PLUGIN-program__time{-webkit-flex-shrink:0;-ms-flex-negative:0;flex-shrink:0;width:4em;opacity:0.7;position:relative}.PLUGIN-program.focus .PLUGIN-program__title{opacity:1;font-weight:500}.PLUGIN-program__progressbar{width:100%;max-width:14em;height:0.25em;border-radius:0.15em;background:rgba(255,255,255,0.15);margin:0.4em 0.5em 0 0;overflow:hidden}.PLUGIN-program__progress{height:100%;background-color:#fff;max-width: 100%}.PLUGIN .card__icon.icon--timeshift{background-image:url(https://epg.rootu.top/img/icon/timeshift.svg);}</style>'.replace(/PLUGIN/g, plugin.component));
...
function pluginPage(object) {
	...
	var bulkFn = bulkWrapper(function (channel) {
		...
		Lampa.Select.show({
			...
			if (!!sel.archive) {
			    ...
			    if (epg) {
				scroll.css({float: "left", width: '40%'});
	...
	if (data.length) {
		...
		scroll.render().css({float: "left", width: '40%'});
