...
function pluginPage(object) {
    ...
    body.toggleClass('list_view', getSettings('list_view'));
    var info;
    var last;
...
langAdd('list_view', {
    ru: 'Список вместо плитки',
    uk: 'Список замість плитки',
    be: 'Спіс замест плітак',
    en: 'List instead of grid',
    zh: '以列表代替网格'
});
...
addSettings(
    'trigger',
    {
	title: langGet('list_view'),
	name: 'list_view',
	default: true,
	onChange: function(v){
	    $('.my_iptv2.category-full').toggleClass('list_view', v === 'true');
	}
    }
);
addSettings(
