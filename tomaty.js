(function () {
    ...
    if (window.kp_ratings_plugin_v117) return;
    window.kp_ratings_plugin_v117 = true;

    var NAME = 'KP Ratings';
    var SETTINGS = 'kp_ratings_settings_v117';
    ...
    var cache = Lampa.Storage.cache('kp_rating_v117', 500, {});
    ...
    function saveRating(key, kp) {
        ...
        cache[key] = item;
        Lampa.Storage.set('kp_rating_v117', cache);
    ...
    function showRatings(kpData, movie) {
        ...
        $('.kp-tmdb-ratings-v117', render).remove();
    ...
    function openRatingModal112(kind, movie, kpData) {
        ...
        setTimeout(function () {
            ...
            modal.find('.kp-rating-modal-close').on('hover:enter click', function (event) {
    ...
    function bindRatingModal112(render, movie, kpData) {
        var root = $('.kp-tmdb-ratings-v117', render);
        if (!root.length) return;

        root.find('.kp-rating-v117').off('hover:enter.kpRatings').on('hover:enter.kpRatings', function () {
            openRatingModal112('kp', movie, kpData);
        });

        root.find('.tmdb-rating-v117').off('hover:enter.kpRatings').on('hover:enter.kpRatings', function () {
    ...
    function start() {
        ...
        if (!document.getElementById('kp-ratings-v117-style')) {
            var style = document.createElement('style');
            style.id = 'kp-ratings-v117-style';
            style.textContent =
                '@keyframes kpRatingsAppear110{from{opacity:0;transform:translateY(7px);}to{opacity:1;transform:translateY(0);}}@keyframes kpRatingsScore110{from{opacity:0;transform:translateY(5px) scale(.97);}to{opacity:1;transform:translateY(0) scale(1);}}.kp-tmdb-ratings-v117{' +
                ...
                '}' +
                '.kp-rating-v117,.tmdb-rating-v117{animation-delay:.08s!important;' +
                ...
                '.tmdb-rating-v117{' +
                    ...
                    'box-shadow:0 5px 18px rgba(0,0,0,.18),inset 0 1px 0 rgba(255,255,255,.05)!important;' +
                '}' +
                '.kp-rating-v117__top,.tmdb-rating-v117__top{' +
                    'display:flex!important;' +
                ...
                '}' +
                '.kp-rating-v117__brand,.tmdb-rating-v117__brand{' +
                    'display:flex!important;' +
                    'align-items:center!important;' +
                    'height:1.15em!important;' +
                    'min-width:0!important;' +
                '}' +
                '.kp-rating-v117__logo{' +
                    'display:block!important;' +
                ...
                '.tmdb-rating-v117__logo{' +
                    ...
                    'object-position:left center!important;' +
                '}' +
                '.kp-rating-v117__quality,.tmdb-rating-v117__quality{' +
                    'font-size:.68em!important;' +
                    'font-weight:600!important;' +
                    'color:rgba(255,255,255,.58)!important;' +
                    'white-space:nowrap!important;' +
                '}' +
                '.tmdb-rating-v117__quality{' +
                    'color:rgba(1,180,228,.88)!important;' +
                '}' +
                '.kp-rating-v117__main,.tmdb-rating-v117__main{' +
                    'display:flex!important;' +
                    'align-items:center!important;' +
                    'justify-content:flex-start!important;' +
                    'gap:1.05em!important;' +
                '}' +
                '.kp-rating-v117__score,.tmdb-rating-v117__score{' +
                    'display:flex!important;' +
                    'align-items:baseline!important;' +
                    'white-space:nowrap!important;' +
                '}' +
                '.kp-rating-v117__score span,.tmdb-rating-v117__score span{' +
                ...
                '}' +
                '.kp-rating-v117__score small,.tmdb-rating-v117__score small{' +
                    'margin-left:.18em!important;' +
                    'font-size:.62em!important;' +
                    'font-weight:500!important;' +
                    'color:rgba(255,255,255,.44)!important;' +
                '}' +
                '.kp-rating-v117__votes,.tmdb-rating-v117__votes{' +
                    'display:flex!important;' +
                    'flex-direction:column!important;' +
                    'line-height:1.15!important;' +
                    'min-width:0!important;' +
                '}' +
                '.kp-rating-v117__votes strong,.tmdb-rating-v117__votes strong{' +
                    'font-size:.9em!important;' +
                    'font-weight:700!important;' +
                    'color:#fff!important;' +
                '}' +
                '.kp-rating-v117__votes span,.tmdb-rating-v117__votes span{' +
                    'margin-top:.16em!important;' +
                    'font-size:.62em!important;' +
                    'color:rgba(255,255,255,.52)!important;' +
                    'white-space:nowrap!important;' +
                '}' +
                '.kp-rating-v117__bar,.tmdb-rating-v117__bar{' +
                ...
                '.kp-rating-modal-close{position:absolute;top:2px;right:14px;z-index:100;width:42px;height:42px;border-radius:50%;display:flex;align-items:center;justify-content:center;box-sizing:border-box;cursor:pointer;background:rgba(12,15,17,.86);backdrop-filter:blur(8px);-webkit-backdrop-filter:blur(8px);transition:transform .15s ease,background .15s ease,box-shadow .15s ease;}' +
                ...
                '.kp-rating-modal-info-grid{grid-template-columns:1fr!important;}' +
                    '.kp-tmdb-ratings-v117{gap:.65em!important;}' +
                    '.kp-rating-v117,.tmdb-rating-v117{padding:.68em .65em .65em!important;}' +
                    '.kp-rating-v117__logo{width:7.2em!important;}' +
                    '.tmdb-rating-v117__logo{width:5em!important;}' +
                    '.kp-rating-v117__score span,.tmdb-rating-v117__score span{font-size:1.7em!important;}' +
                    '.kp-rating-v117__main,.tmdb-rating-v117__main{gap:.55em!important;}' +
                '}';
        ...
        Lampa.Listener.follow('full', function (e) {
            ...
            if ($('.kp-rating-v117', render).length) return;
