(function () {
    ...
    function addStyles() {
        ...
        style.textContent = `
            ...
            .kp-settings-input.focus,
            .kp-settings-input:hover {
                border-color: var(--kp-accent);
                background: rgba(255,255,255,.09);
            }
            ...
            .kp-settings-button.focus,
            .kp-settings-button:hover {
                border-color: rgba(255,255,255,.3);
                background: rgba(255,255,255,.09);
            }

            .kp-settings-button--primary {
                background: var(--kp-accent);
                border-color: transparent;
                color: #201400;
            }

            .kp-settings-button--primary.focus,
            .kp-settings-button--primary:hover {
                filter: brightness(1.08);
            }
            ...
            .kp-settings-status.kp-settings-status--error {
                color: #f18686;
            }

            .button--kp-settings svg {
                width: 22px;
                height: 22px;
            }
    ...
    function openSettingsModal() {
        ...
        const html = $(`
            <div class="kp-settings">
                ...
                <div class="kp-settings-label">
                    API-ключ Kinopoisk
                </div>

                <div class="kp-settings-hint">
                    Свой бесплатный ключ можно получить на
                ...
                <div class="kp-settings-input-wrap">
                    <input
                        type="text"
                        class="kp-settings-input selector"
                        id="kp-settings-key-input"
                        placeholder="Вставьте API-ключ"
                        value="${escapeHtml(currentKey)}"
                    >
                </div>

                <div class="kp-settings-buttons">
                    <div
                        class="kp-settings-button kp-settings-button--primary selector"
                        id="kp-settings-save"
                    >
                        Сохранить
                    </div>
                    ...
                    <div
                        class="kp-settings-button selector"
                        id="kp-settings-clear"
                    >
                        Очистить
                    </div>
                </div>

                <div class="kp-settings-status" id="kp-settings-status"></div>
        ...
        const status = html.find("#kp-settings-status");
        const input = html.find("#kp-settings-key-input");


        html
            .find("#kp-settings-save")
            .on("hover:enter click", function () {
                ...
                if (!value) {
                    status
                        .addClass("kp-settings-status--error")
                        .text("Введите ключ перед сохранением.");
                    return;
                }
                ...
                status
                    .removeClass("kp-settings-status--error")
                    .text("Ключ сохранён.");
            });


        html
            .find("#kp-settings-clear")
            .on("hover:enter click", function () {
                        ...
                        >
                            ...
                            >
                                ...
                                <path
                                    ...
                                    a.5.5 0 0 0-.61-.22
                                    l-2.39.96
                                    c-.5-.38-1.03-.7-1.62-.94
                                    l-.36-2.54
                                    a.5.5 0 0 0-.5-.42
                                    h-3.84
                                    a.5.5 0 0 0-.5.42
                                    l-.36 2.54
                                    c-.59.24-1.13.57-1.62.94
                                    l-2.39-.96
                                    a.5.5 0 0 0-.61.22
                                    L2.74 8.84
                                    a.5.5 0 0 0 .12.64
                                    ...
                                    l-2.03-1.58z
                                    M12 15.6
                                    a3.6 3.6 0 1 1 0-7.2
                                    3.6 3.6 0 0 1 0 7.2z
                                    "
                                />
