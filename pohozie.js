(function () {
  ...
  function injectStyles() {
    ...
    $('<style id="' + PLUGIN_ID + '_styles">').text([
      ...
      '.similar-plugin__grid { display:grid; grid-template-columns:repeat(3, 1fr); gap:1.5em; }',
      ...
      '.similar-plugin__card .card__title { margin-top:0.5em; font-size:0.9em; white-space:nowrap; overflow:hidden; text-overflow:ellipsis; color:#ddd; }',
      '.similar-plugin__year { font-size:0.8em; color:rgba(255,255,255,0.35); margin-top:0.2em; }',
