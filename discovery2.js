(function () {
    ...
    function startPlugin() {
        if (window.__lampa_discovery_v24_ready) return;
        window.__lampa_discovery_v24_ready = true;

        if (!Lampa.Component || typeof Lampa.Component.add !== 'function') {
            console.error('[Lampa Discovery v24] Component API unavailable');
            return;
        }
        ...
        addMenu();
        console.log('[Lampa Discovery v24] Discovery rows ready');
    }
