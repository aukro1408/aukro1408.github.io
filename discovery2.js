(function () {
    ...
    function styleForYouIcon() {
        try {
            $('.ldg-for-you-icon').css({
    ...
    function startPlugin() {
        if (window.__lampa_discovery_v20_ready) return;
        window.__lampa_discovery_v20_ready = true;

        if (!Lampa.Component || typeof Lampa.Component.add !== 'function') {
            console.error('[Lampa Discovery v20] Component API unavailable');
            return;
        }
        ...
        addMenu();
        console.log('[Lampa Discovery v20] Discovery rows ready');
    }
    ...
    setTimeout(styleForYouIcon, 300);
    setTimeout(styleForYouIcon, 1200);
