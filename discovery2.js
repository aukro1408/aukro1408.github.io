(function () {
    ...
    function startPlugin() {
        if (window.__lampa_discovery_v23_ready) return;
        window.__lampa_discovery_v23_ready = true;

        if (!Lampa.Component || typeof Lampa.Component.add !== 'function') {
            console.error('[Lampa Discovery v23] Component API unavailable');
            return;
        }
        ...
        addMenu();
        console.log('[Lampa Discovery v23] Discovery rows ready');
    }
