(function () {
    ...
    function startPlugin() {
        if (window.__lampa_discovery_v22_ready) return;
        window.__lampa_discovery_v22_ready = true;

        if (!Lampa.Component || typeof Lampa.Component.add !== 'function') {
            console.error('[Lampa Discovery v22] Component API unavailable');
            return;
        }
        ...
        addMenu();
        console.log('[Lampa Discovery v22] Discovery rows ready');
    }
