 ...
 * Облегчённая сборка: новинки проката и стриминги.
 * Визуальное оформление исходных карточек и баннеров сохранено без изменений.
 */
(function () {
    'use strict';
...
*/
    ...
    // =================================================================
    function init() {
        // Оставлены только компоненты, необходимые для карточек стримингов.
        Lampa.Component.add('studios_main', StudiosMain);
        Lampa.Component.add('studios_view', StudiosView);

        // Исходные стили и API-обработчики оставлены для полного совпадения дизайна.
        addStyles();
        overrideApi();
        addHeroRow();
        addStudioRow();
